...
int main(int argc, const char* argv[]) {
    if (argc == 1) {
        cout << "Help" << endl;
        cout << "param 1: [L = 0] ...................... lower bound for sorting" << endl;
        cout << "param 2: M ............................ upper bound for sorting" << endl;
        cout << "param 3: [step = 1] ................... what steps to take for plot" << endl;
        cout << "param 4: [iter = 1] ................... how many iterations to make" << endl;
        cout << "param 5: [limit = M * iter] ........... how many iterations to make" << endl;
        cout << "param 6: [type = 1111] ................ int, string, huge or slow 1 if yes 0 otherwise" << endl;
        return 0;
    }
    assert(argc < 8);
    std::srand(std::time(NULL));
    int M, step, L, iter, limit;
    std::string type;
    switch(argc) {
        case 2:
            sscanf(argv[1], "%d", &M);
            L = 0; step = 1; iter = 1; limit = M*iter; type="1111"; break;
        case 3:
            sscanf(argv[1], "%d", &L);
            sscanf(argv[2], "%d", &M);
            step = 1; iter = 1; limit = M*iter; type="1111"; break;
        case 4:
            sscanf(argv[1], "%d", &L);
            sscanf(argv[2], "%d", &M);
            sscanf(argv[3], "%d", &step);
            iter = 1; limit = M*iter; type="1111"; break;
        case 5:
            sscanf(argv[1], "%d", &L);
            sscanf(argv[2], "%d", &M);
            sscanf(argv[3], "%d", &step);
            sscanf(argv[4], "%d", &iter);
            limit = M*iter; type="1111"; break;
        case 6:
            sscanf(argv[1], "%d", &L);
            sscanf(argv[2], "%d", &M);
            sscanf(argv[3], "%d", &step);
