...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip  \emph{int}, 10000 el.]{Graf prikazuje čase
    urejanja različnih sortirnih algoritmov v odvisnosti od dolžine polja, vse
    od dolžine 1 do 10000. Program je za vsako dolžino polja naredil 100
...
\begin{figure}[h!]
    ...
    \end{center}
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{int}, 10000 el. -- približano]{Približan
...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{string}, 10000 el.]{Graf prikazuje čase
    urejanja različnih sortirnih algoritmov za tip \emph{string} v odvisnosti od dolžine polja, vse
    od dolžine 1 do 10000. Program je za vsako dolžino polja naredil 10
...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{string}, 10000 el. -- približano]
...
saj praktično 200 krat slabša od urejanja s kopico. To se tudi vidi na
...
sliki~\ref{fig:rez:huge1000}, saj sto zadnji trije algoritmi praktično edini
vidni na sliki.
...
\subsection{Tip \emph{slow}}
V konfiguraciji, dobljeni za tip \emph{slow} (razdelek~\ref{chapter:rez:slow}) vidimo, da se najprej uporablja urejanje z vstavljanjem, nato pa
...
V tabeli~\ref{tab:rez:slow} vidimo, da je pri desetih elementih je najboljši nekompozitni algoritem urejanje z
...
na prejšnjih primerih, ne splača na tako krakih poljih. Urejanje s kopico kot
nerekurziven algoritem je na tretjem mestu med nekompozitnimi. V širši
