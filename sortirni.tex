...
števil. Izbrani pivoti so obarvani.
...
\begin{figure}[h!]
    ...
    iteracij. Samo spodnji del grafa je prikazan na sliki~\ref{fig:rez:intblizu}.}
    \label{fig:rez:int}
\end{figure}
...
\begin{figure}[h!]
    ...
    \end{center}
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{int}, 10.000 el. -- izrez]{Približan
...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{string}, 1000 el. -- izrez]{Graf prikazuje čase
...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{string}, 10.000 el. -- izrez]
    {Slika prikazuje le spodnji del grafa na sliki~\ref{fig:rez:string10000},
