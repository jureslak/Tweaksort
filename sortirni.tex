...
\begin{figure}[ht]
    ...
    vstavljanjem}
    \caption*{{ \small Urejanje z zlivanjem je prikazano 
...
\begin{figure}[ht]
    ...
    \end{center}
    \vspace{-0.7cm}
    \caption[Urejanje z izbiranjem]{Grafična predstavitev urejanja z navadnim
    vstavljanjem.}
...
Maksimalno kopico tako predstavimo kot tako zaporedje elementov $a_i, a_{i+1}, \ldots,
...
Maksimalna kopica je prikazana na sliki~\ref{fig:kopica}.
...
\begin{figure}[ht]
    ...
    \caption*{ {\small Grafična predstavitev urejanja s kopico.
...
Slika je bila ustvarjena s programsko kodo, dostopno na spletnem naslovu: 
\url{http://corte.si/posts/code/visualisingsorting/index.html.}}}
...
\begin{figure}[ht]
    ...
    \end{center}
    \vspace{-0.7cm}
    \caption{Ideja kompozitnega sortirnega algoritma.}
...
\begin{table}[h!]
  \centering
  \caption{Skupen čas urejanja za tip \emph{int}}
...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{int}, 1000 el.]{Rezultati za tip \emph{int},
    1000 elementov.}
    ...
    1000 iteracij. Prikazan je le del grafa, da se vidi
...
\begin{table}[h!]
  \centering
  \caption{Skupen čas urejanja za tip \emph{string}}
  \caption*{{\small Skupne čase urejanja smo dobili tako, da za posamezen algoritem 
...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{string}, 1000 el. -- izrez]{Rezultati za tip
    \emph{string}, 1000 elementov.}
    \caption*{{\small Graf prikazuje čase
...
\begin{table}[h!]
  \centering
  \caption{Skupen čas urejanja za tip \emph{huge}}
...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{huge}, 1000 el. -- izrez]{Slika
...
\begin{figure}[h!]
    ...
    \vspace{-0.7cm}
    \caption[Rezultati za tip \emph{slow}, 1000 el. -- izrez]{Slika
...
zahtevo po naključnem dostopu v polju. Prav tako bi lahko raziskovali tudi
odvisnost algoritmov od predhodnega vrstnega reda podatkov v polju.
\pagebreak
